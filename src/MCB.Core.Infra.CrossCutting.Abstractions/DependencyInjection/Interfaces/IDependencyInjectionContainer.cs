using MCB.Core.Infra.CrossCutting.Abstractions.DependencyInjection.Enums;

namespace MCB.Core.Infra.CrossCutting.Abstractions.DependencyInjection.Interfaces;
...
public interface IDependencyInjectionContainer
{
    ...
    void Register<TAbstractionType, TConcreteType>(DependencyInjectionLifecycle lifecycley);
